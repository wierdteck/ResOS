...
4. Open Compliance and mark one high-risk item complete.
5. Open Safety and show unsafe temperature highlighting.
6. Open Suppliers and update a price to create a history row.
7. Open Reputation and generate a review reply plus profile update plan.
